...
export class FastGPTApi implements LLMApi {
  ...
  path(path: string): string {
    ...
    // base地址：DEFAULT_FASTGPT_BASE_URL
  ...
  async chat(options: FastGPTChatOptions) {
    ...
    console.log("[OneAPI Request] OneAPI payload: ", requestPayload);
      ...
      if (shouldStream) {
        ...
        fetchEventSource(chatPath, {
          ...
          async onopen(res) {
            ...
            console.log("[OneAPI] response content type: ", contentType);
